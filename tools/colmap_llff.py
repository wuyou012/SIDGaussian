...
def pipeline(scene, base_path, n_views):
    ...
    # with open('../sparse/0/images.bin', "rb") as fid:
    ...
    #             #     image_name += current_char.decode("windows-1252")
    #             current_char = read_next_bytes(fid, 1, "c")[0]
    #         images[image_name] = binary_image_properties[1:]
    #         print(images)
...
for scene in ['fern', 'flower', 'fortress',  'horns',  'leaves',  'orchids',  'room',  'trex']:# ['bonsai', 'counter', 'garden', 'kitchen', 'room', 'stump']:
    pipeline(scene, base_path = '/home/data1/nerf_llff_data/', n_views = 3)  # please use absolute path!
