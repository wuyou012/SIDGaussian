...
from gaussian_utils.graphics_utils import getWorld2View2
from gaussian_utils.pose_utils import generate_ellipse_path, generate_spiral_path
from gaussian_utils.general_utils import vis_depth
...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, args):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        # fps = 1 / (time_taken*3) if time_taken > 0 else 0
        # print(f"FPS: {fps:.2f}")
